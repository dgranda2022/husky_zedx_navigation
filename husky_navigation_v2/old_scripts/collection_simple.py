...
class WaypointPathRecorderSimplified(Node):
    def __init__(self):
        ...
        self.pose_subscriber = self.create_subscription(
            PoseStamped,
            "/zed/zed_node/pose", # IMPORTANT: Your motion capture pose topic, changed to the ZED camera
            self.pose_callback,
            10
        )
    ...
    def select_sparse_waypoints_from_path(self, min_distance_thresh=0.2, min_angle_thresh_rad=0.26):
